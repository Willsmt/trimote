...
export function SiteFooter() {
  ...
  return (
    <footer className="border-t border-borda bg-superficie">
      <div className="mx-auto flex max-w-3xl flex-col items-center justify-between gap-2 p-4 text-sm text-texto-secundario sm:flex-row">
        <span>Trimote © {year}</span>
        <Link href="/privacidade" className="transition-colors hover:text-primaria">
